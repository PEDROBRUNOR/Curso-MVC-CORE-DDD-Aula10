...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Projeto.Curso.Core.Domain.Pedidos.Entidades.Fornecedores", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Projeto.Curso.Core.Domain.Pedidos.Entidades.ItensPedidos", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Projeto.Curso.Core.Domain.Pedidos.Entidades.Pedidos", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Projeto.Curso.Core.Domain.Pedidos.Entidades.Produtos", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.OwnsOne("Projeto.Curso.Core.Domain.Shared.ValueObjects.CpfCnpjVO", "CPFCNPJ", b1 =>
                        {
                            ...
                            b1.HasOne("Projeto.Curso.Core.Domain.Pedidos.Entidades.Fornecedores")
                                .WithOne("CPFCNPJ")
            ...
            modelBuilder.Entity("Projeto.Curso.Core.Domain.Pedidos.Entidades.ItensPedidos", b =>
                {
                    b.HasOne("Projeto.Curso.Core.Domain.Pedidos.Entidades.Pedidos", "Pedido")
                        .WithMany("ItensPedidos")
                        .HasForeignKey("IdPedido")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Projeto.Curso.Core.Domain.Pedidos.Entidades.Produtos", "Produto")
                        .WithMany("ItensPedidos")
            ...
            modelBuilder.Entity("Projeto.Curso.Core.Domain.Pedidos.Entidades.Produtos", b =>
                {
                    b.HasOne("Projeto.Curso.Core.Domain.Pedidos.Entidades.Fornecedores", "Fornecedor")
                        .WithMany("Produtos")
